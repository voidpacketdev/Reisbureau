...
$berichten = $conn->query("SELECT * FROM contactberichten WHERE gelezen = 1 AND gearchiveerd = 0 ORDER BY datum DESC")->fetchAll();
...
<div class="card mb-4">
    <div class="card-header">
        <h2 class="contactberichten-title">Gelezen berichten</h2>
    </div>
    <?php if (!$berichten): ?>
        <p class="text-muted">Geen gelezen berichten gevonden.</p>
    <?php endif; ?>
